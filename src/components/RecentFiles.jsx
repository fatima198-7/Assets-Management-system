...
function RecentFiles({ iconColor = "text-gray-200", enableCopyModal = false }) {
  ...
  const [listItems, setListItems] = useState(Array(8).fill(baseItem));
                ...
                <th colSpan={6}>
                  <div className="flex items-center justify-between p-3">
                    <div className="flex items-center gap-3">
                      ...
                      {/* Action icons */}
                      <div className="flex items-center ml-4 overflow-x-auto gap-2">
          ...
          <tbody>
            {listItems.map((item, index) => (
                  ...
                  >
                    <div>
                      ...
                      <div className="bg-white p2">
                        <span
                          className="absolute -top-2 right-0 mt-1 bg-white text-black text-[10px] px-2 py-1 rounded 
             ...
             whitespace-nowrap min-w-[90px] text-center"
                        ...
                        <span
                          className="absolute top-3 right-0 mt-1 bg-white text-black text-[10px] px-2 py-1 rounded 
             opacity-0 group-hover:opacity-100 transition pointer-events-none shadow 
             whitespace-nowrap min-w-[90px] text-center"
                        >
                          {copiedIndex === index
